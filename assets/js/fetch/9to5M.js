document.addEventListener("DOMContentLoaded", async () => {
  const rssUrl =
    "https://api.codetabs.com/v1/proxy?quest=https://9to5mac.com/feed/"; // Replace with your RSS feed URL
  const latestPostsContainer = document.getElementById("latest-posts-9to5-mac");
