document.addEventListener("DOMContentLoaded", async () => {
  const rssUrl =
    "https://api.codetabs.com/v1/proxy?quest=http://feed.androidauthority.com/"; // Replace with your RSS feed URL
  const latestPostsContainer = document.getElementById("latest-posts-ap");
